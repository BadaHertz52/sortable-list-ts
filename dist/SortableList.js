...
const SortableList = ({ data, onClickItem, renderItem, updateData, }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("ul", Object.assign({ className: "sortable-list", ref: listRef, onTouchMove: onTouchMove, onTouchEnd: onTouchEnd }, { children: [listData.map((item, index) => ((0, jsx_runtime_1.jsx)(SortableListItem_1.default, Object.assign({ index: index, draggable: true, onDropItem: onDropItem, onDragStart: onDragStart, onClickItem: onClickItem, mobileDrag: mobileDrag, setMobileDrag: setMobileDrag }, { children: renderItem(item, index) }), index))), (0, jsx_runtime_1.jsx)(SortableListItem_1.default, { index: listData.length, draggable: false, onDropItem: onDropItem, mobileDrag: mobileDrag, setMobileDrag: setMobileDrag }, listData.length), mobileDrag && ((0, jsx_runtime_1.jsx)("div", Object.assign({ className: "drag-item", style: dragItemStyle }, { children: (0, jsx_runtime_1.jsx)(SortableListItem_1.default, Object.assign({ index: startIndex, draggable: false, onDropItem: onDropItem, mobileDrag: mobileDrag, setMobileDrag: setMobileDrag }, { children: renderItem(listData[startIndex], startIndex) }), listData.length) })))] })));
};
